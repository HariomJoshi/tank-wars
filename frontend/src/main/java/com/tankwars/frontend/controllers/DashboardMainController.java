...
public class DashboardMainController {
    ...
    public void initialize() {
        ...
        dashboardActions.add(buttonTwoPlayers);
        ...
        buttonTwoPlayers.setOnAction(e->{
            try{
                handleTwoPlayers();
    ...
    private void handleTwoPlayers() throws IOException{
        Stage twoPlayersStage = new Stage();
        FXMLLoader twoPlayersLoader = new FXMLLoader(getClass().getResource("/com/tankwars/frontend/two-players-initial.fxml"));
        Scene twoPlayersScene = new Scene(twoPlayersLoader.load());
        twoPlayersStage.setScene(twoPlayersScene);
        twoPlayersStage.initStyle(StageStyle.UNDECORATED);
        twoPlayersStage.initModality(Modality.APPLICATION_MODAL);
