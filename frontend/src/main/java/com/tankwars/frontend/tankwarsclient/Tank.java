...
public class Tank extends Group {
    ...
    public Tank(double x, double y, Color bodyColor, Color trackColor, boolean isFacingLeft) {
        ...
        bodyImage = new Image(getClass().getResource("/images/tank2.png").toExternalForm());
        // Tank Body
...
//    public void draw(GraphicsContext gc, double x, double y, Tank tank) {
////        // Example drawing logic for the tank (could be custom drawing based on your Tank object)
////        gc.setFill(Color.GREEN);
////        gc.fillRect(bodyImage,x, y - height, width, height); // Draw tank as a rectangle
//        gc.drawImage(bodyImage, x, y-height, width, height);
//    }
